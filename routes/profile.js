...
profileRouter.post("/profile/delete/savedImages", userAuth, async (req, res) => {
    try {
        ...
        if ( profileImage !== "TechTribe_User_Profile_Avatar/Logos/Logo_b00c785c-9eae-43ca-b97b-4c12f4341344" && !avatars.includes(profileImage) && profileImage !== userProfileImage  ) {
